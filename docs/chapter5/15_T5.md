...
<div align="center">
  <img src="images/5_3_1.png" alt="Text-to-Text 框架示意图" />
...
<div align="center">
  <img src="images/5_3_2.png" alt="Span Corruption 预训练目标示意图" />
...
这段逻辑体现了 T5 设计者的巧思。人类语言对近距离的依赖非常敏感（如主谓搭配），需要精确建模；而对于远距离的依赖，只需要知道“大概很远”就足够了。这种设计既捕捉了长距离信息，又节省了参数。
