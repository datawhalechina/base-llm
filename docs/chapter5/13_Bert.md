...
> **MLM 的局限**
>
> 由于 MLM 是随机 Mask 单个字或子词，可能会割裂一个完整词语的内部语义联系。例如，对于 “哈利波特” 这个词，模型可能会只 Mask “哈” 或 “利”，而无法在词的层面上进行学习。为了解决这个问题，后续的研究提出了 **WWM (Whole Word Masking, 全词掩码)** 的策略。即如果一个词的一部分被选中进行 Mask，那么这个词的所有部分都会被一起 Mask。这项技术在中英文任务上都取得了效果提升。
...
> **NSP 的有效性讨论**
>
> 后续研究（如 RoBERTa, ALBERT）对 NSP 的有效性提出了质疑，发现在更大规模的预训练下，移除它或用其他任务替代（如句子顺序预测）会带来更好的效果。
>
